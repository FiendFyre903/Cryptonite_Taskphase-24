flag - `pwn.college{cWJZhHxfFkRmgTV80CJFWNUd-tN.0VM2IDLxEzN0czW}`

```
hacker@reverse-engineering~level6-0:/challenge$ ./* 
###
...
Initial input:
	...
	61 62 63 64 65 0a 00 00 00 00 00 00 00 00 00 00 00 00 00 
...
pwn.college{cWJZhHxfFkRmgTV80CJFWNUd-tN.0VM2IDLxEzN0czW}
```